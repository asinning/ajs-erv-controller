"""Tests for AJS ERV Controller api."""
import asyncio

import aiohttp
from custom_components.ajs_erv_controller.api import (
    AjsErvControllerApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = AjsErvControllerApiClient("test", "test", async_get_clientsession(hass))
